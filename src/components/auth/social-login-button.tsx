...
export const SocialLoginButton = ({
  ...
  // Priority: propCallbackUrl > paramCallbackUrl > current pathname
  const callbackUrl = propCallbackUrl || paramCallbackUrl || pathname || '/';
    ...
    await authClient.signIn.social(
      ...
      },
      {
        ...
        onSuccess: (ctx) => {
          ...
          trackAuth('login', provider, ctx.data?.user?.id);
          setIsLoading(null);
        },
        onError: (ctx) => {
