...
export const CANONICAL_BASE_URL = 'https://www.universaltowerdefense-z.wiki';
...
function getUtdzBaseUrl(url?: string) {
  ...
  try {
    ...
    if (
      parsedUrl.hostname === 'universaltowerdefense-z.wiki' ||
      parsedUrl.hostname === 'www.universaltowerdefense-z.wiki'
    ) {
...
export function getBaseUrl(): string {
  ...
  const utdzBaseUrl = getUtdzBaseUrl(configuredBaseUrl);
  if (utdzBaseUrl) {
    return utdzBaseUrl;
  }
