...
export function usePricePlans(): Record<string, PricePlan> {
  ...
  if (priceConfig.plans.max) {
    plans.max = {
      ...priceConfig.plans.max,
      name: t('max.name'),
      description: t('max.description'),
      features: [
        t('max.features.feature-1'),
        t('max.features.feature-2'),
        t('max.features.feature-3'),
        t('max.features.feature-4'),
        t('max.features.feature-5'),
        t('max.features.feature-6'),
        t('max.features.feature-7'),
        t('max.features.feature-8'),
        t('max.features.feature-9'),
        t('max.features.feature-10'),
      ],
      limits: [],
    };
  }
