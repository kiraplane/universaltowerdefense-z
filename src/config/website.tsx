...
export const websiteConfig: WebsiteConfig = {
  ...
  metadata: {
    images: {
      ogImage: '/utdz/media/official-1.png',
      logoLight: '/utdz/icon.png',
      logoDark: '/utdz/icon.png',
    },
    social: {
      github: '',
      twitter: '',
  ...
  mail: {
    provider: 'resend',
    fromEmail:
      'Universal Tower Defense Z Wiki <hello@universaltowerdefense-z.wiki>',
    supportEmail: 'hello@universaltowerdefense-z.wiki',
  },
  newsletter: {
    enable: false,
    provider: 'resend',
